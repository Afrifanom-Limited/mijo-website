      ...
      <div className="max-w-4xl mx-auto px-6 space-y-12">
        <div className={`text-center mx-auto max-w-3xl`}>
          <div className="block lg:hidden">
            <h2 className="text-3xl font-bold md:text-4xl">Talk To Us</h2>
            <p className="text-gray-500 pt-4 font-light">
              Ready to get started? Talk to our sales team to learn how VaMijo
              can help your business manage and move orders more efficiently.
            </p>
          </div>
